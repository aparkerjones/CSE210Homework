...
class Program
{
    ...
    {
        List<Scripture> scriptList = new List<Scripture>//list of new scriptures
        {
        ...
        int scripture = rando.Next(0,scriptList.Count);//get a random number to represent one of the possible verses
